...
Even though utilizing the approach of selecting features via maximizing the Adjusted R-squared as opposed to minimizing BIC....
we decided upon proceeding with BIC as the evaluation criteria due to having nearly half of the number of selected features in the final model.
