...
rf.rna_features_rf <- randomForest(label ~ ., data = rf_train_data_top_subset, mtry = 100, num.trees = 20, importance = TRUE) # RF Model
...
rf.rna_features_ranger <- ranger::ranger(x = x, y = y, mtry = 5000, num.trees = 20, importance = "impurity") # RF Model
...
plot(roc_rf, main = "Random Forest ROC Curve") # 0.8642072 
```
