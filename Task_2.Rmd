...
elastic_cv_fit <- cv.glmnet(elastic_net_train_data_matrix, train_labels, alpha = 0.5, lambda = grid, nfolds = 5, family = "binomial", weights = class_weights)
...
# Fit the final model using the best lambda
elastic_final_model <- glmnet(elastic_net_train_data_matrix, train_labels, alpha = 0.5, lambda = elastic_lambdas[elastic_best_lambda_index], family = "binomial", weights = class_weights)
...
elastic_test_balanced_accuracy <- calculate_balanced_accuracy(confusion_test)
