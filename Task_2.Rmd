...
for (i in 1:nrow(grid_search)) {
  params <- list(
    ...
    eval_metric = "auc",
    nthread = 4 # Adjust this based on your machine's capability
  )
  ...
  # Train final model if current AUC is better
  if (mean_auc > best_balanced_accuracy) {
    best_balanced_accuracy <- mean_auc
...
# Output results
cat("Final Balanced Accuracy:", final_balanced_accuracy, "\n")
cat("Selected Features Count:", length(selected_features), "\n")

xgb_model_end <- Sys.time()
xgb_model_total_time <- xgb_model_end - xgb_model_start
cat("Time taken for model training and selection:", xgb_model_total_time, "\n")
