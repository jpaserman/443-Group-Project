...
train_data_clean_matrix <-as.matrix(train_data[,-1])
grid <- 10^seq(10, -2, length = 100)
fit.lasso <-glmnet(train_data_clean_matrix,train_data$label, alpha = 1, lambda = grid)





cv.lasso <-cv.glmnet(train_data_clean_matrix, train_data$label)

pred.test_lasso <-predict(fit.lasso, test_data_clean_matrix)
