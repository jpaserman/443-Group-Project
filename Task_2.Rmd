...
### Recursive Feature Elimination (RFE) SVM (Peter)
...
svm_rfe <- rfe(x = x_train, y = y_train, sizes = c(1:10), rfeControl = ctrl, method = "svmLinear")
...
plot(roc_svm_rfe, main = "SVM with RFE ROC Curve") # 0.8257457 
