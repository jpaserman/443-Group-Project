...
write.csv(lda_pred, file = "lda_predictions.csv", row.names = TRUE)
```


```{r lda_load, include = FALSE}
lda_pred <- read.csv("lda_predictions.csv") %>% 
...
write.csv(logreg_pred, file = "logreg_predictions.csv", row.names = TRUE)
```


```{r logreg_load, include = FALSE}
logreg_pred <- read.csv("logreg_predictions.csv") %>% 
