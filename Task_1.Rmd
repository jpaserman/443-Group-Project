...
train_split = as.integer(nrow(task_one_df)*0.7)
...
### Next steps --> 
  ...
  ### percentage change. then plot boxplots for the top 5? 10? variables
  ...
  ### (2) instead of having 3829 hard-coded above as the proportion of data
  ### in the training set, instead have a parameter at the beginning of the
  ### script to set the proportion

  ### (3) set a seed at the begining of the script so that the sample command
  ### for determining training/test set partitions the data consistently
...
```{r}
covariates = mean_table$genes[1:500]
formula = as.formula(
  paste(
    "label ~",
