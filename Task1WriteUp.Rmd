...
|----------|------------|---------------|---------------|------------|
| LDA      | 0.94155    | 0.9407        | 0.9407        | **0.9526** |
| Logistic | 0.6393     | 0.6413        | 0.6596597     | 0.6858     |
| QDA      | N/A        | N/A           | N/A           | N/A        |
| k-NN     | 0.7425     | 0.6964        | 0.6963545     | 0.5983     |
| GBDT     | 0.9068     | 0.8856        | **0.9723815** | 0.9283     |
| RF       | 0.9352     | 0.9171        | 0.9170923     | 0.9500     |
...
|---------------|---------------|---------------|---------------|-------------|
| LDA                 | 0.93515982     | 0.91756581     | 0.98915349     | 0.90791180     |
| Logistic            | 0.94885845     | **0.94136394** | **0.99134549** | 0.93086420     |
| QDA                 | 0.94155251     | 0.92980804     | 0.98758220     | 0.91939547     |
| k-NN                | 0.91598174     | 0.89409755     | 0.89409755     | 0.87862797     |
| GDBT                | 0.8666667      | 0.8340888      | 0.9481581      | 0.7988981      |
| RF                  | 0.93789954     | 0.92545064     | 0.92545064     | 0.91414141     |
| SVM (Linear Kernel) | 0.94885845     | 0.94089042     | 0.94089042     | 0.93069307     |
| SVM (Radial Kernel) | **0.94977169** | 0.93973058     | 0.93973058     | **0.93116395** |
=======
| with PCA            | Accuracy   | Bal. Accuracy | AUC        | F1         |
|---------------------|------------|---------------|------------|------------|
| LDA                 | 0.9361     | 0.9188        | **0.9892** | 0.9506     |
| Logistic            | 0.9489     | **0.9423**    | 0.9423     | 0.9593     |
| QDA                 | 0.9406     | 0.9300        | 0.9874     | 0.9186     |
| k-NN                | 0.9114     | 0.8384        | 0.8900     | 0.8725     |
| GDBT                | 0.8594     | 0.8165        | 0.9577     | 0.8948     |
| RF                  | 0.9342     | 0.9235        | 0.9235     | **0.9482** |
| SVM (Linear Kernel) | 0.9489     | 0.9418        | 0.9479     | 0.9310     |
| SVM (Radial Kernel) | **0.9498** | 0.9402        | 0.9402     | 0.9313     |
>>>>>>> 9225afb (write up commit)
...
|-----------------------|-----------------|----------------|
| QDA/LDA??             |                 |                |
| Logistic (with Ridge) | 0.6858          |                |
| RF (with AdaBoost)    | 0.9482          | 0.9629         |
